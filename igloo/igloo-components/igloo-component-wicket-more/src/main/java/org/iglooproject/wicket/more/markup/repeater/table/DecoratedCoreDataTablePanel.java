...
public class DecoratedCoreDataTablePanel<T, S extends ISort<?>> extends Panel implements IPageableItems {
	...
	public static class TitleLabelAddInComponentFactory<T, S extends ISort<?>> extends AbstractParameterizedComponentFactory<Component, DecoratedCoreDataTablePanel<T, S>> {
	...
	public static class TitleCountAddInComponentFactory<T, S extends ISort<?>> extends AbstractParameterizedComponentFactory<Component, DecoratedCoreDataTablePanel<T, S>> {
		private static final long serialVersionUID = 7358590231263113101L;
